...
namespace DeadCellsMultiplayerMod.MultiplayerModUI.Connection
{
    ...
    internal static class LobbyHeadSkin
    {
        ...
        {
            public Part(string group, double offsetX, double offsetY, int? colorLight)
            {
                Group = group;
                OffsetX = offsetX;
                OffsetY = offsetY;
        ...
        internal static bool TryResolve(string headId, out string atlas, out List<Part> parts)
        {
            atlas = "customHead";
            parts = new List<Part>();
                    ...
                    try
                    {
                        ...
                        if (props != null)
                        {
                            for (int p = 0; p < props.length; p++)
                            {
                                ...
                                parts.Add(new Part(group, ox, oy, colorLight));
                            }
                        }
                    }
                    catch
